...
export const apiGetUser = (userName: string) => apiGet<IResponse<IUser>>(`/users/${userName}`)
...
export const apiUserEmailVerified = () =>
  apiGet<IResponse<EmailVerifiedResponse>>(`/users/email/verified`)

export const apiGetBaseUserInfo = () => apiGet<IResponse<BaseUserInfo[]>>(`/admin/users/baseinfo`)
