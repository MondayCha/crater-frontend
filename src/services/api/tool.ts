...
export const apiGetPodContainers = (namespace?: string, podName?: string) =>
  apiGet<IResponse<ContainerStatusResponse>>(`/namespaces/${namespace}/pods/${podName}/containers`)

export const apiGetPodEvents = (namespace?: string, podName?: string) =>
  apiGet<IResponse<KubernetesEvent[]>>(`/namespaces/${namespace}/pods/${podName}/events`)
...
export const apiGetPodContainerLog = (
  ...
  return apiGet<IResponse<string>>(
...
export const apiGetPodIngresses = (namespace: string, podName: string) =>
  apiGet<IResponse<PodIngressesList>>(`/namespaces/${namespace}/pods/${podName}/ingresses`)
...
export const apiCreatePodIngress = (
  ...
  apiPost<IResponse<PodIngress>>(`/namespaces/${namespace}/pods/${podName}/ingresses`, ingressMgr)
...
export const apiDeletePodIngress = (
  ...
  apiDelete<IResponse<string>>(`/namespaces/${namespace}/pods/${podName}/ingresses`, {
    data: ingressMgr,
  })
...
export const apiGetPodNodeports = (namespace: string, podName: string) =>
  apiGet<IResponse<PodNodeportsList>>(`/namespaces/${namespace}/pods/${podName}/nodeports`)
...
export const apiCreatePodNodeport = (
  ...
  apiPost<IResponse<PodIngress>>(`/namespaces/${namespace}/pods/${podName}/nodeports`, nodeportMgr)
...
export const apiDeletePodNodeport = (
  ...
  apiDelete<IResponse<string>>(`/namespaces/${namespace}/pods/${podName}/nodeports`, {
    data: nodeportMgr,
  })
